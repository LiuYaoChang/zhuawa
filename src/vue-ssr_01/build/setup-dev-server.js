 ...
 * 
 * @param {express} app 
 * @param {HTML 文件} htmlTemplate 
 * @param { Function } callback 
 */
module.exports = function setupDevServer(app, htmlTemplate, callback) {
  ...
  template = fs.readFileSync(htmlTemplate, 'utf-8')
  chokidar.watch(htmlTemplate).on('change', () => {
      template = fs.readFileSync(htmlTemplate, 'utf-8')
